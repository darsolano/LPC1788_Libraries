...
void lpc_norflash_get_id(UNS_16 *manu_id, UNS_16 *device_id)
{
	...
	wsBoard_NorFlash_WriteCmd(0x5555, 0xAAAA);
	wsBoard_NorFlash_WriteCmd(0x2AAA, 0x5555);
	wsBoard_NorFlash_WriteCmd(0x5555, 0x9090);
	...
	*manu_id = wsBoard_NorFlash_ReadCmdData(0x0000);
	/* Read Device ID. It should be 0x235B for SST39VF3201 and 0x235A for SST39VF3202*/
	*device_id = wsBoard_NorFlash_ReadCmdData(0x0001);

	/* Exit Product Identification Mode */
	wsBoard_NorFlash_WriteCmd(0x5555, 0xAAAA);
	wsBoard_NorFlash_WriteCmd(0x2AAA, 0x5555);
	wsBoard_NorFlash_WriteCmd(0x5555, 0xF0F0);
...
void lpc_norflash_erase_sector(UNS_32 sec_addr)
{
	wsBoard_NorFlash_WriteCmd(0x5555, 0xAAAA);
	wsBoard_NorFlash_WriteCmd(0x2AAA, 0x5555);
	wsBoard_NorFlash_WriteCmd(0x5555, 0x8080);
	wsBoard_NorFlash_WriteCmd(0x5555, 0xAAAA);
	wsBoard_NorFlash_WriteCmd(0x2AAA, 0x5555);
	wsBoard_NorFlash_WriteCmd(sec_addr, 0x3030);
}
...
void lpc_norflash_write_word(UNS_32 addr, UNS_16 data)
{
	wsBoard_NorFlash_WriteCmd(0x5555, 0xAAAA);
	wsBoard_NorFlash_WriteCmd(0x2AAA, 0x5555);
	wsBoard_NorFlash_WriteCmd(0x5555, 0xA0A0);
	wsBoard_NorFlash_WriteWord(addr, data);
}
...
{
	return wsBoard_NorFlash_ReadWord(addr);
}
