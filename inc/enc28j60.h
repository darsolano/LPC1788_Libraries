...
/*
 * Data Structure to hold mac address bytes
 */
typedef struct
{
	uint8_t mac_addr[6];
...
// Structure to hold the ID of the Chip
typedef struct
{
	uint8_t rev_lev;
	uint8_t part_no;
...
extern Bool     enc28j60linkup(void);
extern void 	enc28j60GetMacAddress(MACADDR_Typedef* mac);
extern Bool     enc28j60IsJabbering(void);
extern void 	enc28j60GetOUI(PHY_ID_Typedef *phy);
extern Bool     enc28j60hasRxPkt(void);
